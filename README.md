...
and the absolute distance between the two enters a weighted conditional logit (mlogit) that treats the vote as a single choice among parties
— with a separate proximity coefficient for each party, alongside party-specific effects of age and education.
